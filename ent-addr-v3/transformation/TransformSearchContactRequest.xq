(:: pragma bea:global-element-parameter parameter="$searchContact1" element="ns2:SearchContact" location="../wsdl/ContactService.wsdl" ::)
...
xf:TransformSearchContactRequest($searchContact1)
