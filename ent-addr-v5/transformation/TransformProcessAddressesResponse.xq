(:: pragma bea:global-element-parameter parameter="$processMultipleAddressesV2010Q2Response1" element="ns0:ProcessMultipleAddressesV2010Q2Response" location="../wsdl/globaladdress.asmx.wsdl" ::)
(:: pragma bea:global-element-return element="ns2:ProcessAddressesResponse" location="../wsdl/AddressService.wsdl" ::)
...
declare namespace xf = "http://tempuri.org/ent-addr-v5/transformation/TransformProcessAddressesResponse/";

declare function xf:TransformProcessAddressesResponse($processMultipleAddressesV2010Q2Response1 as element(ns0:ProcessMultipleAddressesV2010Q2Response))
    as element(ns2:ProcessAddressesResponse) {
        <ns2:ProcessAddressesResponse>
                ...
                return
                    <AddressPostal>
                        ...
                        }
                        {
                            ...
                            return
                                <Postcode status="{ fn:substring($TheACR,17,1) }">{ data($Country) }</Postcode>
                        }
                        {
...
xf:TransformProcessAddressesResponse($processMultipleAddressesV2010Q2Response1)
