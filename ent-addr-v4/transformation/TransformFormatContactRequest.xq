(:: pragma bea:global-element-parameter parameter="$formatContact1" element="ns2:FormatContact" location="../wsdl/ContactService.wsdl" ::)
...
xf:TransformFormatContactRequest($formatContact1)
